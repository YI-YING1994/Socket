...
class RepeatTimer(threading.Timer):
    pre_size = 0 # 暫存 calculate_speed 的 pre。
    total_size = 0 # 提供外部更新 calculate_speed 的 total 的接口。
    ...
    def run(self):
        ...
        while not self.finished.is_set():
            self.pre_size = self.function(self.pre_size, self.total_size, **self.kwargs)
